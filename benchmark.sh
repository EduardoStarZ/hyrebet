...
wrk -c 10 -d 5m -t 4 -H "Cookie: Auth=Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlZHVhcmRvIiwiZXhwIjoxNzY0ODU1Mjk3fQ.M_OsPdEWkTbvTASTCUpiC-LLS8AYLna-a3pW7OTaVxI" --latency http://127.0.0.1:4000/json/ > test-results/5m-home-json-rl.txt
...
wrk -c 10 -d 5m -t 4 -H "Cookie: Auth=Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlZHVhcmRvIiwiZXhwIjoxNzY0ODU1Mjk3fQ.M_OsPdEWkTbvTASTCUpiC-LLS8AYLna-a3pW7OTaVxI" --latency http://127.0.0.1:4000/json/eduardo > test-results/5m-profile-json-rl.txt
...
wrk -c 10 -d 5m -t 4 -H "Cookie: Auth=Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJlZHVhcmRvIiwiZXhwIjoxNzY0ODU1Mjk3fQ.M_OsPdEWkTbvTASTCUpiC-LLS8AYLna-a3pW7OTaVxI" --latency http://127.0.0.1:4000/json/eduardo/104924087 > test-results/5m-post-json-rl.txt
